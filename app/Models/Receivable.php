...
class Receivable extends Model
{
    ...
    public static function generateInvoiceNumber(): string
    {
        ...
        return 'AR-' . $year . '-' . str_pad($number, 6, '0', STR_PAD_LEFT);
    }
    ...
    public function updatePaymentStatus(): void
    {
        ...
        } elseif ($this->due_date < now() && !in_array($this->status, [self::STATUS_VOID, self::STATUS_BAD_DEBT])) {
     ...
     * Mark as bad debt
     */
    public function markAsBadDebt(): void
    {
        $this->update(['status' => self::STATUS_BAD_DEBT]);
    }
}
