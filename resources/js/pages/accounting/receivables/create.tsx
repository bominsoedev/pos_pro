...
export default function CreateReceivable({ customers, incomeAccounts }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: t('common.create'), href: '/accounting/receivables/create' },
        ]}>
            <Head title={t('accounting.create_receivable')} />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold flex items-center gap-2">
                            ...
                            {t('accounting.create_receivable')}
                        </h1>
                        <p className="text-muted-foreground">{t('accounting.create_receivable_description')}</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl">
                        ...
                        <CardContent className="space-y-4">
                            <div>
                                ...
                                <Select
                                    ...
                                    onValueChange={(v) => setData('customer_id', v ? parseInt(v) : null)}
                                >
                                    <SelectTrigger>
                                        <SelectValue placeholder={t('accounting.select_customer')} />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div>
                                <Label>{t('accounting.income_account')}</Label>
                                <Select
                                    value={data.income_account_id?.toString() || ''}
                                    onValueChange={(v) => setData('income_account_id', v ? parseInt(v) : null)}
                                >
                                    <SelectTrigger>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    {t('accounting.income_account_help')}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <Textarea
                                    ...
                                    rows={2}
                                    placeholder={t('accounting.receivable_description_placeholder')}
                                />
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="flex justify-end gap-4 mt-6">
                        <Button variant="outline" asChild>
                            <Link href="/accounting/receivables">{t('common.cancel')}</Link>
                        </Button>
