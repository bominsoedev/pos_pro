...
export default function BundlesCreate({ products }: BundlesCreateProps) {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: t('bundles.create'), href: '/bundles/create' },
        ]}>
            <Head title={t('bundles.create')} />
            <div className="flex h-full flex-1 flex-col gap-2 overflow-x-auto rounded-lg p-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">{t('bundles.create')}</h1>
                        <p className="text-muted-foreground">{t('bundles.create_description')}</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-2">
                    <Card className="backdrop-blur-sm bg-background/80 border-sidebar-border/70">
                        ...
                        <CardContent className="space-y-3">
                            <div>
                                <Label htmlFor="product_id">{t('bundles.main_product')} *</Label>
                                <Select
                                ...
                                >
                                    <SelectTrigger>
                                        <SelectValue placeholder={t('bundles.select_main_product')} />
                                    </SelectTrigger>
                                    <SelectContent>
