...
export default function WaysCreate() {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: t('ways.create'), href: '/ways/create' },
        ]}>
            <Head title={t('ways.create')} />
            <div className="flex h-full flex-1 flex-col gap-2 overflow-x-auto rounded-lg p-3">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">{t('ways.create')}</h1>
                        <p className="text-muted-foreground">{t('ways.create_description')}</p>
                    </div>
                </div>
